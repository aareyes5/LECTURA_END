...
def evaluar_texto(texto):
    ...
    niveles = {
        0: ["tranquilo", "relajado", "calmado", "en paz"],
        1: ["ocasionalmente", "ligeramente", "en circunstancias especiales"],
        2: ["a veces", "de vez en cuando", "algo ansioso"],
        3: ["preocupado", "nervioso", "estresado", "en tensión"],
        4: ["tenso", "nervioso", "agitado", "angustiado"],
        5: ["muy ansioso", "extremadamente nervioso", "temeroso", "desesperado"],
...
def predecir_puntaje(edad, sexo, puntaje3):
    ...
    entrada = np.array([[edad, sexo, 0, puntaje3, 0, 0, 0, 0, 0, 0, 0]])  # Los valores de las preguntas 3-10 se inicializan en 0
    entrada_estandarizada = scaler.transform(entrada)
    predicciones = model.predict(entrada_estandarizada)
    puntaje_predicho = predicciones[0][0]  # La predicción de la Pregunta 3 es el primer valor
