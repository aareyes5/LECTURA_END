...
def evaluar_texto(texto):
    ...
    niveles = {
    0: ["pensamientos positivos", "optimista", "sin pensamientos negativos", "bien", "contento", "alegre", "tranquilo"],
    1: ["ligeros pensamientos negativos", "ocasionalmente pesimista", "a veces preocupado", "leve inquietud", "tristeza leve"],
    2: ["pensamientos negativos a veces", "pesimismo ocasional", "preocupado", "a menudo triste", "inquietud constante"],
    3: ["pensamientos pesimistas frecuentes", "preocupado y negativo", "triste la mayor parte del tiempo", "ansioso", "estado de ánimo bajo"],
    4: ["pensamientos muy pesimistas", "totalmente negativo", "angustiado", "deprimido", "incapaz de sentir alegría"],
    5: ["extremadamente pesimista", "sin esperanza", "totalmente negativo", "desesperado", "depresión grave", "mucha angustia"],
    6: ["pensamientos suicidas", "desesperanza total", "pensamientos graves y desesperados", "deseo de no vivir", "autolesión", "crisis emocional grave"]
}
...
if __name__ == "__main__":
    ...
    audio_filename = os.path.join(audio_folder, f'Audio_9.wav')
    ...
    guardar_puntaje_en_datos(datos_file_path, puntaje_predicho, pregunta_num=9)